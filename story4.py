...
def story4(debug = False):
    ...
    easteregg1 = getegg("answer this y or n do you like waffles?", debug)
    ...
    out += " we say our goodbyes until " + badname1 + " has a change of heart and saves us by getting rid of " + badname2 +", " + badname3 +",and " + badname4
